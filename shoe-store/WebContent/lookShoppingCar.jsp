...
<HTML><body background =D:\eclipse\shoe\image\back.jpg id=tom>
<div align="center">
<%  if(loginBean==null){
    ...
    out.print("<tr>");
    out.print("<th id=tom width=120>"+"鞋子标识(id)");
    out.print("<th id=tom width=120>"+"鞋子名称");
    out.print("<th id=tom width=120>"+"鞋子价格");
